...
iris=load_iris()#导入鸢尾花数集
data=iris.data
target=iris.target
pca=PCA(n_components=2)#将鸢尾花数降维
newData=pca.fit_transform(data)
print(newData)
x_train,x_test,y_train,y_test=train_test_split(newData,target,test_size=0.25,random_state=33)#将鸢尾花数集进行分割
